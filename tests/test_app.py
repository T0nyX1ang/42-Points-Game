...
class TestException(unittest.TestCase):
    def test_exceptions(self):
        ...
        self.assertEqual(str(FTPtsGameError(0x21, (1, 2, 3))), 'AnswerError:UnmatchedNumber[(1, 2, 3)]')
        self.assertEqual(str(FTPtsGameError(0x22, '6*7+0+0+0')), 'AnswerError:RepeatedAnswer[6*7+0+0+0]')
